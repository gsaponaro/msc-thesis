/*****************************************************************************************
*	SCDTR - Classe myMatrix	
* 
*	Manipulação de matrizes genéricas
*
*
*	Paulo Carreiras  Nº52247
******************************************************************************************/
...
public:
	//construtores
	myMatrix(void);											//construtor default
	myMatrix(int _nLines, int _nColumns);					//construtor parametrizado
	myMatrix(int _nLines, int _nColumns, gType *_data);		//construtor parametrizado com valores
	myMatrix(int _nLines, int _nColumns, gType value);		//construtor parametrizado com valor da diagonal
	myMatrix(const myMatrix &orig);							//construtor cópia

	//destructor
	~myMatrix(void);										//destructor

	//overload de operadores
	myMatrix operator +(const myMatrix &orig);				//overload do operador "+"
	myMatrix operator -(const myMatrix &orig);				//overload do operador "-"
	myMatrix& operator =(const myMatrix &orig);				//overload do operador "="
	myMatrix operator *(const myMatrix &orig);				//overload do operador "*" (matriz por matriz)
	myMatrix operator *(const gType value);					//overload do operador "*" (matriz por escalar)
	myMatrix operator /(const myMatrix &orig);				//overload do operador "/" (matriz por matriz)
	myMatrix operator /(const gType value);					//overload do operador "/" (matriz por escalar)
	myMatrix operator ^(const int value);					//overload do operador "^" (potencia inteira)
	template <class gType>
	friend ostream& operator <<(ostream &out, myMatrix &orig); //overload do operador "<<"
	template <class gType>
	friend myMatrix operator *(const double value, myMatrix &orig); //overload do operador "*" (escalar por matriz)
	//overload do operador ">>"
	istream& read(istream& is=cin);
	template <class gType>
	friend istream& operator>>(istream& is, myMatrix<gType> *M1){return M1->read(is);};
	template <class gType>
	friend istream& operator>>(istream& is, myMatrix<gType> &M1) {return M1.read(is);};

	//Funcoes utilitarias
	myMatrix Transposta(void);								//transpoe a matriz
	...
	template <class gType>
	friend void loadMatrices(char *fname, myMatrix * MM, int n);
	template <class gType>
	friend void saveMatrices(char *fname, myMatrix * MM, int n);
	...
	void getMatrixPart(myMatrix &newM, const int partNumber, const int pixelsBorder); //retorna uma submatriz de uma matriz
	void putMatrixPart(const myMatrix &orig, const int partNumber, const int pixelsBorder); //insere uma submatriz numa matriz
	gType myMatrix<gType>::media();
...
*****************************************************************************/
//construtor default.
//Cria objecto myMatrix com as dimensões predefinidas e inicializado a zero
template <class gType>
myMatrix<gType>::myMatrix(void){
...
//Cria objecto myMatrix com as dimensões especificadas e inicializado a zero
template <class gType>
myMatrix<gType>::myMatrix(int _nLines, int _nColumns){
...
*****************************************************************************/
//construtor parametrizado.
//Cria objecto myMatrix com as dimensões especificadas e inicializado com os
//valores contidos no vector dado
template <class gType>
myMatrix<gType>::myMatrix(int _nLines, int _nColumns, gType *_data){ 
...
*****************************************************************************/
//construtor parametrizado.
//Cria objecto myMatrix com as dimensões especificadas e inicializado na 
//diagonal com o valor dado
template <class gType>
myMatrix<gType>::myMatrix(int _nLines, int _nColumns, gType _value){ 
...
//construtor cópia.
template <class gType>
myMatrix<gType>::myMatrix(const myMatrix<gType> &orig){ 
...
//Overload do operador ">>"
template <class gType>
istream& myMatrix<gType>::read(istream& is)
{
	int i,j,k;
...
//Overload do operador "+"
template <class gType>
myMatrix<gType> myMatrix<gType>::operator +(const myMatrix<gType> &orig){

#ifdef DEBUG
	cout << "---->Chamada do overload do operador \"+\"" << endl;
#endif
	
	myMatrix<gType> temp(*this);
...
myMatrix<gType> myMatrix<gType>::operator *(const myMatrix<gType> &orig){
	...
	myMatrix<gType> temp(nLines, orig.nColumns);
...
template <class gType>
myMatrix<gType> myMatrix<gType>::operator *(const gType value){

#ifdef DEBUG
	cout << "---->Chamada do overload do operador \"*\" (matriz por escalar)" << endl;
#endif
	
	myMatrix<gType> temp(nLines, nColumns);
...
template <class gType>
myMatrix<gType> myMatrix<gType>::operator ^(const int value){
	...
	if(value>1){
		myMatrix<gType> temp =(*this)^(value/2);
...
//Overload do operador "<<"
template <class gType>
ostream & operator <<(ostream &out, myMatrix<gType> &orig){
...
template <class gType>
myMatrix<gType> operator *(const double value, myMatrix<gType> &orig){

#ifdef DEBUG
	cout << "---->Chamada do overload do operador \"*\" (escalar por matriz)" << endl;
#endif
	
	myMatrix<gType> temp(orig.nLines, orig.nColumns);
...
template <class gType>
myMatrix<gType> myMatrix<gType>::Transposta(void){
	
#ifdef DEBUG
	cout << "---->Chamada da funcao Transposta" << endl;
#endif

	myMatrix<gType> temp(nColumns, nLines);
...
template <class gType>
gType myMatrix<gType>::Determinante(void){
...
template <class gType>
void myMatrix<gType>::putMatrixPart(const myMatrix<gType> &orig, const int partNumber, const int pixelsBorder){
...
template <class gType>
void myMatrix<gType>::getMatrixPart(myMatrix<gType> &newM, const int partNumber, const int pixelsBorder){
...
template <class gType>
void myMatrix<gType>::IntroduzValor(int nLine, int nColumn, gType value){
...
template <class gType>
void myMatrix<gType>::Inicializa(void){
...
//Visualiza a matriz
template <class gType>
void myMatrix<gType>::Visualiza(void){
...
template <class gType>
int myMatrix<gType>::existeNaMatrix(const gType value){
...
template <class gType>
gType myMatrix<gType>::getValue(const int position){
...
template <class gType>
void myMatrix<gType>::setValue(const int position, const gType value){
...
+----------------------------------------------------------------------------*/
template <class gType>
void myMatrix<gType>::minv(double *mat,int n,double *d,double *invmat)
{
...
template <class gType>
void loadMatrices(char *fname, myMatrix <gType> * MM, int n)
{
...
template <class gType>
void saveMatrices(char *fname, myMatrix <gType> * MM, int n)
{
